    ...
    <div className="relative">
      ...
      <div ref={Contact} className=" bg-black min-h-screen relative flex justify-center items-center overflow-hidden">
        <div className="mt-0 sm:mt-5 z-10 flex flex-col gap-5">
          <div>
            <div className=" text-white flex flex-col justify-center items-center ">
              <div className="tracking-10-no-margin sm:text-[13px] font-extralight">Thank You For Visiting</div>
              <div className="tracking-20-no-margin text-4xl sm:text-6xl font-extrabold">CONTACT US</div>
              <div className="absolute bottom-[10px] text-xs sm:text-[10px] font-extralight">Made by @itsmeprinceyt</div>
            </div>
          </div>
          <div className="flex justify-center items-center gap-5 sm:gap-10 text-orange-500">
          <Link 
            className="hover:scale-125 border-2 border-orange-500 p-4 rounded-full"
